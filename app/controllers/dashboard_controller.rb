class DashboardController < ApplicationController
    def index
        ...
        accepted_value_sql = "SELECT sum(price) AS 'price' FROM buybacks WHERE status LIKE '%Review%'"
        ...
        v_total_value_sql = "SELECT sum(price) AS 'price' FROM buybacks WHERE status LIKE '%Review%' AND vendor = '" + current_user.custom + "'"
        ...
        v_accepted_value_sql = "SELECT sum(price) AS 'price' FROM buybacks WHERE status LIKE '%Keep%' AND vendor = '" + current_user.custom + "'"
